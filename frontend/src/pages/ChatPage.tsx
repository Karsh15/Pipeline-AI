  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, {
        role: "ai",
        content: "Based on the recent models, 'Sunrise Hotel Plaza' has the highest NOI margin at 34%, compared to the portfolio average of 28%. Would you like me to generate a comparison table?",
      }]);
    }, 1500);
  };
